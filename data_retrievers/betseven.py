...
async def betseven_tennis():
    ...
    for event in result_events:
        event_data = {
            ...
            'url': 'https://www.betseven16.com/sportsbook/5/events/' + str(event['id'])
        }
...
async def get_american_football_events():
    nfl = "https://www.betseven16.com/iapi/sportsbook/v2/tournaments/31"
    cfl = "https://www.betseven16.com/iapi/sportsbook/v2/tournaments/790"
...
async def betseven_american_football():
    ...
    for event in result_events:
        event_data = {
            ...
            'start_time': event['startTime'],
            'start_time_ms': convert_time(event['startTime']),
            'url': 'https://www.betseven16.com/sportsbook/2/events/' + str(event['id'])
        }
...
async def betseven_football():
    ...
    for event in result_events:
        ...
        event_data = {
            ...
            'start_time': event['startTime'],
            'start_time_ms': convert_time(event['startTime']),
            'url': 'https://www.betseven16.com/sportsbook/1/events/' + str(event['id'])
        }
...
async def get_events(sport_arg):
    ...
    comps_url = (
        f"https://www.betseven16.com/iapi/sportsbook/v2/sports/{sport_id}").format(sport_id=sport_id)
    ...
    events_url = f"https://www.betseven16.com/iapi/sportsbook/v2/sports/{sport_id}/events?timespan=24&{'&'.join(params)}&{market_type_ids}"
